...
from inventory.views import ProductTypeViewSet, DepartmentApiView
...
urlpatterns = [
    ...
    path('departments/<int:pk>', DepartmentApiView.as_view({'get': 'retrive', 'patch' : 'parital update', 'put' : 'update', 'delete' : 'delete'})),
    ]
